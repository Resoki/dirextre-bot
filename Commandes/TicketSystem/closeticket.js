...
module.exports = {
  ...
  run: async(client, message, args) => {
    ...
    if(channelName) {
      ...
      const embedLog = new Discord.MessageEmbed().setDescription(`${message.author.username} a **fermé** son ticket`).setColor('RED').setImage(message.author.displayAvatarURL({dynamic: true}))
